...
function MockSectionBar({ label, color }: { label: string; color: string }) {
  return (
...
function MockTextArea({ placeholder }: { placeholder: string }) {
  return (
    <div className="border-2 border-gray-200 rounded-xl px-3 py-2 bg-white">
...
function MockCopyButton() {
  return (
    <div className="bg-yellow-400 rounded-xl px-4 py-3 text-center">
      <span className="text-base font-bold text-gray-900">レポートをコピー</span>
    </div>
  );
}
...
function MockScreen({ children }: { children: React.ReactNode }) {
  return (
    <div className="bg-blue-50 rounded-2xl p-4 border-2 border-blue-100 mt-3">
      {children}
    </div>
  );
}
    ...
    <main className="min-h-screen bg-blue-50 px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link
            href="/daily"
            className="bg-white border-2 border-blue-200 text-blue-600 font-bold px-4 py-2 rounded-xl text-sm hover:bg-blue-50 transition-all shadow-sm"
          >
            ← もどる
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-blue-700">使い方ガイド</h1>
            <p className="text-sm text-gray-500">日報入力アプリの使い方</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-blue-700">日報の作り方</h2>
          </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <MockScreen>
                  <div className="bg-white rounded-2xl p-5 max-w-xs mx-auto border-t-4 border-blue-500 shadow-sm">
                    <div className="text-center mb-4">
                      <div className="text-2xl mb-2">📋</div>
                      <p className="font-bold text-blue-700 text-sm">日報入力</p>
                      <p className="text-xs text-gray-400">パスワードを入力してください</p>
                    </div>
                    <div className="border-2 border-blue-300 rounded-xl px-3 py-2 text-center text-sm text-gray-500 mb-3 bg-blue-50">
                      ••••••••••
                    </div>
                    <div className="bg-yellow-400 rounded-xl px-4 py-2 text-center">
                      <span className="text-sm font-bold text-gray-900">ログイン</span>
                    </div>
                  </div>
                </MockScreen>
              </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mb-3">入室時に行ったことをタップします。選んだボタンは<span className="text-blue-600 font-bold">青色</span>に変わります。</p>
                <MockScreen>
                  <MockSectionBar label="① 入室" color="bg-blue-600" />
                  <div className="flex flex-wrap gap-2 mt-3">
                    <MockChip label="挨拶" active />
                    <MockChip label="健康管理" active />
                  </div>
                  <p className="text-xs text-blue-600 mt-2 font-medium">← 青になったら選択済みです</p>
                </MockScreen>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <MockScreen>
                  <div className="border-2 border-blue-300 rounded-xl px-4 py-3 bg-white">
              ...
              <div className="flex-1">
                ...
                <MockScreen>
                  <div className="flex flex-col gap-3">
                    <div>
                      <MockSectionBar label="② 身体介護" color="bg-blue-500" />
                      <p className="text-xs text-gray-500 mt-2 mb-1.5">整容</p>
                    ...
                    <div>
                      <MockSectionBar label="③ 生活援助" color="bg-emerald-600" />
                      <p className="text-xs text-gray-500 mt-2 mb-1.5">清掃（複数選べます）</p>
                      <div className="flex flex-wrap gap-2">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <MockScreen>
                  <MockSectionBar label="④ 退室確認" color="bg-orange-500" />
                  <div className="flex flex-wrap gap-2 mt-3">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mb-3"><span className="text-yellow-600 font-bold">黄色いボタン</span>を押すと、日報の文章が自動的に作られてコピーされます。</p>
                <MockScreen>
                  <MockCopyButton />
                  <div className="mt-3 bg-blue-100 border-2 border-blue-300 rounded-xl p-3">
                    <p className="text-xs text-blue-600 font-bold mb-1">コピーした内容</p>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                  <p className="text-sm text-yellow-800 font-medium">貼り付けのやり方</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-3xl">📊</span>
            <h2 className="text-xl font-bold text-emerald-700">スプレッドシートへのテンプレ追加</h2>
          </div>

          <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-4 mb-6">
            <p className="text-sm text-emerald-800 font-medium">テンプレを変更・追加したいときは、Googleスプレッドシートに直接入力するだけです。特別な操作は必要ありません。</p>
          </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex flex-col gap-1">
                  <div className="flex items-center gap-2 bg-blue-50 rounded-xl p-3">
                    <div className="bg-white border-2 border-blue-200 rounded-lg px-3 py-1.5">
                      <span className="text-xs text-blue-500">hint</span>
                      <span className="font-mono text-sm font-bold text-blue-700 ml-1">挨拶</span>
                    </div>
                    <span className="text-sm text-gray-500">← 右のリストのボタンを押してコピー</span>
                  </div>
                </div>
                <MockScreen>
                  <div className="overflow-hidden rounded-xl border border-gray-300">
                    <div className="grid grid-cols-2">
                      ...
                      <SpreadsheetCell>
                        <span className="font-bold text-blue-600">挨拶</span>
                      </SpreadsheetCell>
                      <SpreadsheetCell>（B列に文章を入力）</SpreadsheetCell>
                      <SpreadsheetCell>
                        <span className="font-bold text-blue-600">健康管理</span>
                      </SpreadsheetCell>
                      <SpreadsheetCell>（B列に文章を入力）</SpreadsheetCell>
                      <SpreadsheetCell>
                        <span className="font-bold text-blue-600">トイレ介助</span>
                      </SpreadsheetCell>
                      <SpreadsheetCell>（B列に文章を入力）</SpreadsheetCell>
                    </div>
                  </div>
                  <p className="text-xs text-blue-600 mt-2 font-medium">← A列には右サイドのコードをそのままコピー</p>
                </MockScreen>
              </div>
            </div>
                ...
                <MockScreen>
                  <div className="overflow-hidden rounded-xl border border-gray-300">
                    <div className="grid grid-cols-2">
                      ...
                      <SpreadsheetCell>
                        <span className="text-blue-600">挨拶して入室しました</span>
                      </SpreadsheetCell>
                      <SpreadsheetCell>挨拶</SpreadsheetCell>
                      <SpreadsheetCell>
                        <span className="text-blue-600">チャイムを鳴らし入室しました</span>
                      </SpreadsheetCell>
                      <SpreadsheetCell>健康管理</SpreadsheetCell>
                      <SpreadsheetCell>
                        <span className="text-blue-600">体調をご確認しました</span>
                      </SpreadsheetCell>
                    </div>
                  </div>
                  <p className="text-xs text-gray-500 mt-2">同じコードを2行入れると、どちらかがランダムで使われます</p>
                </MockScreen>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 bg-green-50 border-2 border-green-200 rounded-xl p-4">
                  <p className="text-sm text-green-800 font-bold">反映されないときは…</p>
                  <p className="text-sm text-green-700 mt-1">アプリのページを再読み込みしてください（ブラウザの更新ボタンを押す）</p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-3xl">📝</span>
            <h2 className="text-xl font-bold text-gray-700">使えるコード一覧</h2>
          </div>
        ...
        <div className="text-center py-4">
          <Link
            href="/daily"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-2xl text-lg transition-all shadow-md"
          >
            日報入力にもどる
          </Link>
        </div>
